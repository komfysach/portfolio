    ...
    <div className='flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        <div className='flex flex-col'>
            {language ? (
                ...
                <h4 className='md:text-4xl text-sm font-semibold'>Here is a <span className='underline decoration-[#c7fcff]/50'>little</span> background</h4>
                <p className='md:text-sm text-xs font-inconsolata'>
                    ...
                    Being a life long learner, I enjoy exploring new tech and keeping up-to-date with innovations in the industry. Currently I am adding NextJS🔼 - which this site is built with, BunJS🥟, QwikJS⚡ and VUE🟩 to my repotoire. Overall, I love adding REAL value✨ wherever I am able to.
                </p>
            </div>
            ) : (
                <div className='md:space-y-10 space-y-3 px-0 md:px-10'>
            ...
            Op dit moment voeg ik NextJS🔼 - waarmee ik deze site heb gebouwd - BunJS🥟, QwikJS⚡ en VUE🟩 toe aan mijn skill set. Kortom, voeg ik graag ECHTE waarde toe ✨waar ik kan.
            </p>
        </div>
            )}
